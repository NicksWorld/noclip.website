...
export class OpaqueShader extends DeviceProgram {
...
layout(location = ${OpaqueShader.a_Position}) in vec3 a_Position;
layout(location = ${OpaqueShader.a_Color}) in uint a_Color;
layout(location = ${OpaqueShader.a_Uv}) in vec2 a_Uv;
layout(location = ${OpaqueShader.a_Normal}) in vec3 a_Normal;
